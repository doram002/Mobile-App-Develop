...
@synthesize mechTxtField, ElecTxtField, bioTxtField, compTxtField;
...
-(void)calculateStats
{
    NSInteger mech = 0, elect = 0, compu = 0, bio = 0;
...
//    
    ...
    {
        NSString *major = [person major]; //change to major after testing..
        
        if([major isEqualToString:@"mechanical"])
        {
            mech++;
        }
        else if([major isEqualToString:@"electrical"])
        {
            elect++;
        }
        else if([major isEqualToString:@"biomedical"])
        {
            bio++;
        }
        else if([major isEqualToString:@"computer"])
        {
            compu++;
        }
